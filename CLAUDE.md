...
- **`com.cuenti.homebanking.base`**: Reusable components and base classes for all features
...
- **`com.cuenti.homebanking.examplefeature`**: Example feature demonstrating the structure
...
1. Create a new package under `com.cuenti.homebanking` (e.g., `com.cuenti.homebanking.myfeature`)
