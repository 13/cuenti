package com.cuenti.homebanking.views.currencies;
...
@Route("currencies")
@Menu(order = 9, icon = LineAwesomeIconUrl.MONEY_BILL_WAVE_SOLID)
@PermitAll
public class CurrencyManagementView extends VerticalLayout {
    ...
    private void setupUI() {
        ...
        grid.addColumn(Currency::getDecimalChar).setHeader("Decimal").setAutoWidth(true);
        grid.addColumn(Currency::getFracDigits).setHeader("Digits").setAutoWidth(true);
        grid.addColumn(Currency::getGroupingChar).setHeader("Grouping").setAutoWidth(true);
